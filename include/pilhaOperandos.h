/*! \file pilhaOperandos.h
	...
	Pilha responsavel por armazenar os operandos da JVM
*/

/*! \def PILHAOPERANDOS_H
	\brief Macro
...
public:
	/** @fn PilhaOperandos(int maxSize)
		@brief Construtor
		@param maxSize Indica tamanho maximo da pilha de operandos
	*/
	PilhaOperandos(int);
