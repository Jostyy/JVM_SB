...
public:
	...
	*/
	...
	/** \fn bool verifyStatus(int status)
		\brief Verifica se status foi informado para o método que chamou
	*/
	...
	*/
	...
	/** \fn Leitor* getClassThatHasSerachedMethod(string name, string descriptor)
...
private:
	...
	*/
	...
	/** \fn string getError(int)
		...
		\param error Indice da mensagem de erro
	*/
	string getError(int);
